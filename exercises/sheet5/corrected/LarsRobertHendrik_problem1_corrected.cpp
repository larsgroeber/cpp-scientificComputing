...
void calcLargestFacWithUperLimit (double lim){
	...
	// BS: this hsould be boolean, to be able to set it `true`! :p
...
void guessNrBetweenOneAndOneHundredButThisNameStillIsntLongEnough(){
    ...
    // BS: yes, it could be longer
    // BS: http://stackoverflow.com/questions/2682027/is-there-a-length-limit-on-g-variable-names
